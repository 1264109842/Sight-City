...
public class TrainingModeTutorialMove : MonoBehaviour { 
	...
	void introMessage()
	{
		EasyTTSUtil.SpeechAdd ("Welcome to training mode tutorial. In this section, we will do a sample training mode and learn" +
		                       " some detail in the training mode.");
		isAllowMove = false;
	...
	*/
	...
	{
		EasyTTSUtil.SpeechAdd ("Door near by instruction indicates that there is a door near the player in the" +
		                       " certain direction.");
