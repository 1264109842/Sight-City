...
public class PlayerMovement_Tutorial : MonoBehaviour { 
	...
	void introMessage()
	{
		EasyTTSUtil.SpeechAdd ("Welcom to Sight City game tutorial. " + 
		                       "In this game, we are going to control a player to explore a floor layout. First " + 
		                       "Let's study how to control the player move forward. Please put your finger on the screen and " +
		                       "swipe it up");
		isAllowMove = false;
		...
		if (mode != 0) {
			...
			case 2: // move forward practice
				EasyTTSUtil.SpeechAdd("Great! you got it!Now you know how to move forward. Let's practice." +
				                      "We need move 10 meters. Notice that if you want to keep the player " +
				                      "moveing, please hold your finger on the scree after you swipe. When you hear the" +
				...
				break;
			case 3: 
				EasyTTSUtil.SpeechAdd ("Excellent job. Now you are going to learn how to turn the player to left. Please put your finger on the screen" +
					"Then swipe it to the left. Let's  try it.");
			...
			case 4: // turn right tutorial
				EasyTTSUtil.SpeechAdd ("Excellent. Now you are going to learn how to turn the player to right. Please put your finger on the screen" +
				                       "Then swipe it to the right. Let's  try it.");
			...
			case 5: // combination of all movement, try a simple route
				EasyTTSUtil.SpeechAdd("Excellent. Let's practice with sample route.");
				Debug.Log (" practice.");
				isAllowMove = false;
				source.Stop();
			...
			case 6: // finish this part and explain the training mode and game mode
				EasyTTSUtil.SpeechAdd ("Very good. You learned how to access the player. You can" +
				                       "make your own training now.");
	...
	*/
	void moveForward()
	{
		...
		if (mode == 2) {
			...
			if(movedDistance >= 10){
				if(trainingTimes >  0){
					EasyTTSUtil.SpeechAdd ("You did a good job. Let's try" + trainingTimes + " more time.");
